...
pillar(X, Y, Z, High, Width, Depth, Actions) :-
    ...
    plan(Actions).
\end{Verbatim}
I primi 3 argomenti sono le coordinate dove verrà costruito il pilastro, i tre seguenti sono le dimensioni del pilastro. L'ultimo argomento è l'output del planner: una lista di azioni che verranno eseguite dal nodo di motion planning.
